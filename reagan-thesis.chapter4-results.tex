...
These velocity observations are designed to simulate an reconstructed velocity measurement based on video particle tracking.
...
Our results indicate that (initially, not plotted) the averaging of temperature over many cells for the synthetic temperature sensors up to 32 sensors degraded prediction skill.
...
In Figure \ref{fig:covlocaladaptive}, flow structures present in our computational experiment demonstrate the potential for adaptive covariance localization.
