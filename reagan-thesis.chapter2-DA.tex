...
%% The canonical choice of $\sigma = 10, b = 8/3$ and $r = 28$ is used for all examples here, which produce the well known butterfly attractor (Figure \ref{fig:lorenzattractor}).
