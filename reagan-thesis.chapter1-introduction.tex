...
This huge discrepancy was due mostly to the fact that his initial conditions were not balanced, and therefore included fast-moving gravity waves which masked the true climate signal \shortcite{kalnay2003}.
...
In this direction, I make use of advanced computational resources a simplified atmospheric experiment to improve prediction skill.
...
\todo{make a proper description of set up}
...
Finally, in chapter 6 we summare the successes of this work and our contributions to the field.
